...
export default function AddFolderButton({ currentFolder }) {
  ...
  return (
    <>
      <Button onClick={openModal} variant="outline-success m-0 mr-2" size="sm" >
